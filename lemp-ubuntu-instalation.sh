...
sudo apt update;
sudo apt install php7.4-fpm php7.4-cli php7.4-curl php7.4-gd php7.4-mysql php7.4-mbstring zip unzip;
...
sudo apt update;
sudo apt install php8.0-fpm php8.0-cli php8.0-curl php8.0-gd php8.0-mysql php8.0-mbstring zip unzip;
...
sudo apt update;
sudo apt install php8.1-fpm php8.1-cli php8.1-curl php8.1-gd php8.1-mysql php8.1-mbstring zip unzip;
...
# Instalacao de php 8.2
sudo apt update;
sudo apt install php8.2-fpm php8.2-cli php8.2-curl php8.2-gd php8.2-mysql php8.2-mbstring zip unzip;

sudo apt -y install unzip zip php8.2 php8.2-mysql php8.2-fpm php8.2-mbstring php8.2-xml php8.2-curl php-dev php-pear libmcrypt-dev;

# Instalacao de php 8.3
sudo apt update;
sudo apt install php8.3-fpm php8.3-cli php8.3-curl php8.3-gd php8.3-mysql php8.3-mbstring zip unzip;
